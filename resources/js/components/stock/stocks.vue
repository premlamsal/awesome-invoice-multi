<template>
  <div>
    ...
    <p class="mb-4">
      <router-link class="btn btn-primary" to="/stockHistory">Stock History</router-link>
    </p>
    <!-- DataTales Example -->
    <div class="card shadow mb-4">
      <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary" style="display: inline-block;">Stocks</h6>
  ...
  methods: {
    ...
    autoCompleteTable() {
      ...
      if (this.searchTableKey != '') {
        ...
        let currObj = this;
        axios.post('/api/stock_search', { searchQuery: this.searchTableKey })
          .then(function(response) {
