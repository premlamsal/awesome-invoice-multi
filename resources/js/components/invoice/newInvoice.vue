          ...
          <div class="col-sm-4">
            ...
            <div class="row">
              <div class="col-sm-6">
                ...
                <date-picker v-model="info.invoice_date" :config="options" v-bind:class="[errors['info.invoice_date'] ?  'is-invalid' : '' , 'form-control']"></date-picker>
...
export default {
  ...
  methods: {
    ...
    createInvoice() {
      ...
      let currObj = this;
      axios
        .post("/api/invoice", { info: this.info, items: this.items })
        .then(function(response) {
