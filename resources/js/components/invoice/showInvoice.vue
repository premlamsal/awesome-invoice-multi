                ...
                <div class="card-body p-0">
                    <div class="row p-5">
                        ...
                        <div class="col-md-6 text-right">
                            <p class="font-weight-bold mb-1">Invoice # {{info.custom_invoice_id}}</p>
                            <p class="text-muted">Invoice on: {{info.invoice_date}}</p>
...
<script>
   ...
   export default{
        ...
        fetchInvoice(){
          ...
          axios.get('/api/invoice/'+this.id)
            .then(function(response){

                Vue.set(currObj.info, 'invoice_no', response.data.invoice.id),
                Vue.set(currObj.info, 'custom_invoice_id', response.data.invoice.custom_invoice_id),
                Vue.set(currObj.info, 'title', response.data.invoice.title),
                Vue.set(currObj.info, 'customer_id', response.data.invoice.customer_id),
                ...
                Vue.set(currObj.info, 'customer_details', response.data.invoice.customer.details),
