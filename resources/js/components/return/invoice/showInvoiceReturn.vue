<template>
<div>
      <button class="btn btn-primary" style="float: right;" @click="printInvoice(info.return_invoice_no)"><span class="fa fa-print"></span></button>
<div class="container" id="printThisBlock">
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body p-0">
                    <div class="row p-5">
                        <div class="col-md-6">
                            <img class="comapny_logo_invoice" v-bind:src="store.store_logo" alt="brand-logo-for-invoice" height="100px" width="100px">
                        ...
                        <div class="col-md-6 text-right">
                            <p class="font-weight-bold mb-1">Invoice # {{info.return_custom_invoice_id}}</p>
                            <p class="text-muted">Return Invoice on: {{info.return_invoice_date}}</p>
 ...
 <button class="btn btn-success" @click="editReturnInvoice(id)">Edit</button>
        ...
        fetchInvoice(){
          ...
          axios.get('/api/return_invoice/'+this.id)
            .then(function(response){
                ...
                Vue.set(currObj.info, 'return_custom_invoice_id', response.data.return_invoice.custom_return_invoice_id),
                Vue.set(currObj.info, 'title', response.data.return_invoice.title),
                ...
                Vue.set(currObj.info, 'sub_total', response.data.return_invoice.sub_total),
                Vue.set(currObj.info, 'taxAmount', response.data.return_invoice.tax_amount),
                Vue.set(currObj.info, 'grand_total', response.data.return_invoice.grand_total),
                Vue.set(currObj.info, 'customer_address', response.data.return_invoice.customer.address),
                Vue.set(currObj.info, 'customer_phone', response.data.return_invoice.customer.phone),
                Vue.set(currObj.info, 'customer_details', response.data.return_invoice.customer.details),
